...
export default function Home() {
  ...
  const forceAuth =
    typeof window !== "undefined" && searchParams.get("add_account") === "1";
    ...
    <div className="min-h-screen bg-white flex flex-col lg:flex-row">
      ...
      <div className="flex-1 flex flex-col justify-center items-center px-8 lg:px-24 py-10 relative">
        ...
        <div className="max-w-[480px] w-full">
          ...
          <h1 className="font-serif text-5xl md:text-[56px] font-bold text-gray-900 mb-3 tracking-tight">
            Happening now
          </h1>
          <p className="text-2xl font-medium text-gray-500 mb-12">
