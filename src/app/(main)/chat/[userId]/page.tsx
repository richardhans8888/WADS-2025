...
import { Phone, Video, MoreVertical, Paperclip, Mic, Send, Smile, ArrowLeft } from 'lucide-react';
...
const messages = [
  ...
  },
  {
    id: 5,
    senderId: 1,
    content: "I think Zustand would be perfect for this scale. It's much simpler.",
    time: "10:35 AM",
    type: "text"
  },
  {
      ...
      <div className="p-4 bg-white border-t">
        <div className="flex items-center gap-2">
          ...
          <div className="flex-1 relative">
            ...
            />
            <Button variant="ghost" size="icon" className="absolute right-1 top-1.5 h-7 w-7 text-gray-400">
